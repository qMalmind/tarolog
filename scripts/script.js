...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let subslider = document.querySelector('.js-subslider');
    if(mySwiper && subslider){
...
if(accordions){
    accordions.forEach(accordion =>{
        accordion.querySelector('details').addEventListener('toggle', ()=>{
            if(accordion.querySelector('details').open == true){
                let groupAccordions = document.querySelectorAll(`.js-accordion[data-group='${accordion.dataset.group}']`);
